...
<div class="home">
        <div class="titulo">
          ...
          <div class="fotos-container">
            ...
            <!-- <div class="fotos-card" style="width:330px;height:250px;position:relative" >
                <div class="fotos-image">
                    ...
                    <div class="fotos-info">
                      <div class="fotos-header">
                        <h2 class="fotos-user" style="position:relative; bottom:31vh">{{$publicacion->titulo}} </h2>
                  </div>
                  <p class="fotos-short-description" style="position:relative; bottom:31vh">{{$publicacion->descripcion}}</p>
                </div>
                <div class="button">
                <form action="{{route('borrarpublicacion')}}" method="post">
                <input type="hidden" name="id" value="{{ $publicacion->id}}">
                    @csrf
                    {{ method_field('DELETE') }}
                        <button type="submit" style="position:relative;bottom: 34vh;left: 91px"  class="btn btn-danger m-4" onclick="return confirm('¿Quieres borrar estpubliccación?')">Borrar</button>
                    </form>
                </div> -->
              </div>
            @endif
